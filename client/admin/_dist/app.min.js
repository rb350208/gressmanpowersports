...
!function(){"use strict";angular.module("app").filter("csv",function(){return function(n){if(n)return n.toString().replace(/,/g,", ")}})}();
!function(){"use strict";angular.module("app").filter("slugify",function(){return function(r){if(r){var e=r.toLowerCase().trim();return e=(e=e.replace(/[^a-z0-9\s-]/g," ")).replace(/[\s-]+/g,"-")}}})}();
!function(){"use strict";function e(e){var t={Success:function(t,n){e.flash={message:t,type:"success",keepAfterLocationChange:n}},Error:function(t,n){e.flash={message:t,type:"danger",keepAfterLocationChange:n}}};return e.$on("$locationChangeStart",function(){var t;(t=e.flash)&&(t.keepAfterLocationChange?t.keepAfterLocationChange=!1:delete e.flash)}),t}e.$inject=["$rootScope"],angular.module("app").factory("AlertService",e)}();
!function(){"use strict";function t(t,e){return function(e){var u={GetAll:function(){return t.get(e).then(n,r)},GetById:function(u){return t.get(e+"/"+u).then(n,r)},Save:function(u){return u._id?t.put(e+"/"+u._id,u).then(n,r):t.post(e,u).then(n,r)},Delete:function(u){return t.delete(e+"/"+u).then(n,r)}};return u};function n(t){return t.data}function r(t){return e.reject(t.data&&t.data.Message)}}t.$inject=["$http","$q"],angular.module("app").factory("DataService",t)}();
...
!function(){"use strict";function t(t,n){var r={GetCurrent:function(){return t.get("/api/users/current").then(e,u)},Update:function(n){return t.put("/api/users/"+n._id,n).then(e,u)}};return r;function e(t){return t.data}function u(t){return n.reject(t.data)}}t.$inject=["$http","$q"],angular.module("app").factory("UserService",t)}();
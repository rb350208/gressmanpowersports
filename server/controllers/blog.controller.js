...
router.get('/about', function (req, res, next) {
    ...
    // meta tags
    vm.metaTitle = 'About' + metaTitleSuffix;
    vm.metaDescription = 'About' + metaTitleSuffix;

    render('about/index.view.html', req, res);
});
//services route
router.get('/engineservices', function (req, res, next) {
    var vm = req.vm;

    // meta tags
    vm.metaTitle = 'Services' + metaTitleSuffix;
    vm.metaDescription = 'Services' + metaTitleSuffix;

    render('engineservices/index.view.html', req, res);
});
//customers route
router.get('/customers', function (req, res, next) {
    ...
    // meta tags
    vm.metaTitle = 'Customers' + metaTitleSuffix;
    vm.metaDescription = 'Customers' + metaTitleSuffix;

    render('customers/index.view.html', req, res);
});
